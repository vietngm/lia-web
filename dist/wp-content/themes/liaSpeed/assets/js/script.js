                    ...
                    <div class="flex gap-2  items-center mt-2">
                      <div style="font-size:12px"> 
                          <a class="flex-shrink-0  ">
                            <div>Đã chia sẻ nhật ký làm đẹp dịch vụ <b class="text-12 font-bold">${diaryItem.services.post_title} </b> được <b>${diaryItem.doctor_name} </b> phụ trách điều trị tại <b>PK LiA Beauty Center</b> </div>
                          </a>
                        <?php endif; ?>
                      </div>
                    </div>
