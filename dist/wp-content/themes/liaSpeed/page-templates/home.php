...
.custom-prev:focus, .custom-next:focus {
    ...
    background-color:#00000021; /* Màu nền đậm hơn */
}
.slick-dots {
    position: absolute;
    bottom: 20px;
		...
		<div class="modal-content">
			...
			<form class="modal-form" id="register-form">
				...
				<div class="form-group">
					...
					<input type="tel" id="phone" name="phone" class="form-input" placeholder="Nhập số điện thoại của bạn" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="form-label" for="franchise-type">Loại hình nhượng quyền</label>
					<select id="franchise-type" name="franchise-type" class="form-input">
						<option value="kisok">LiA Kisok</option>
						<option value="home">LiA Home</option>
						<option value="prime">LiA Prime</option>
						<option value="mall">LiA Mall</option>
						<option value="retreat">LiA Retreat</option>
					</select>
				</div>
