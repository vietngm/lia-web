...
<a href="<?= get_permalink() ?>" class="overflow-hidden h-full flex flex-col rounded-1.5">
	...
	<div class="flex-1 flex flex-col border-1 border-t-0 border-gray-300 rounded-b-1.5 p-2">
		<div class="flex justify-between items-center mb-1.5" style="border-bottom: 1px dashed rgb(227, 227, 227);padding-bottom: 5px;">
			<div class="flex items-center gap-1">
				<img class="w-4 h-4" src="<?= get_theme_file_uri("assets/images/icons/star-yellow.svg") ?>" />
				<div class="text-10"  style="font-weight:800;margin-bottom: -2px;"><?= $fields["rating"] ?? 5 ?> / <?= $fields["rating_number"] ?? 100 ?> </div>
			</div>
