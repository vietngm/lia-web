...
<script>
  ...
  const doctors = BOOKING_DATA.doctors; // Danh sách tất cả bác sĩ
  ...
  if (storedServiceId) {
    ...
    if (selectedService) {
      ...
      // Lọc danh sách bác sĩ theo doctorIds của dịch vụ
      const doctorIds = Array.isArray(selectedService.doctorIds) ? selectedService.doctorIds : [];
        ...
        console.log("Danh sách bác sĩ:", filteredDoctors);
        

      // Cập nhật danh sách bác sĩ vào dropdown
      const doctorSelect = $(".input-doctor select");
      doctorSelect.html('<option value="">Chọn bác sĩ</option>'); // Xóa dữ liệu cũ, thêm option mặc định
                        ...
                        <div class="grid grid-cols-2 gap-x-6">
                            <div class="lg:col-span-1 col-span-2">
                                ...
                                <div class="input-select mb-4 input-doctor">
                                    <select placeholder="Chọn bác sĩ" name="doctor">
                                        <option></option>
                            ...
                            <div class="lg:col-span-1 col-span-2">
                                ...
                                <div class="booking-date-picker mb-0">
                                    ...
                                    <label class="item other">
                                        ...
                                        <input type="text" inputmode="none" class="datetimepicker w-full h-0 opacity-0 pointer-events-none block" name="date" data-min-date="<?= date("Y-m-d"); ?>" />
                                    </label>
                                </div>
