  ...
  <div class="<?= $sticky ? "sticky top-[64px]" : "" ?> pt-3 bg-white">
    ...
    <div class="adv-filter">
      ...
      <div class="flex overflow-x-auto gap-3 no-scrollbar">
        ...
        <select class="dropdown-select flex-shrink-0" multiple placeholder="Danh mục" name="category"
          placement="bottom-start" rows="2" data-modal-class="category-modal">
          ...
          <option value="<?= $term_category_id ?>-<?= $term_category_child->term_id ?>">
            <?= $term_category_child->name ?></option>
