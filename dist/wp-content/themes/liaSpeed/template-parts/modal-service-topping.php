...
<script>
        ...
        function saveSelectedOption(storageKey, selector) {
            document.querySelectorAll(selector).forEach(input => {
                input.addEventListener("change", function () {
                    ...
                    const selectedOptionDesire = document.querySelector(`.option-desire[data-name="${this.getAttribute("data-name")}"]`);
                    if (selectedOptionDesire) {
                        selectOptionDesire(selectedOptionDesire);
                    }
                    const selectedOptionMaterial = document.querySelector(`.option-material[data-name="${this.getAttribute("data-name")}"]`);
                        if (selectedOptionMaterial) {
                            selectOptionMaterial(selectedOptionMaterial);
                        }
                    const selectedOptionBh = document.querySelector(`.option-bh[data-name="${this.getAttribute("data-name")}"]`);
                        if (selectedOptionBh) {
    ...
    <div class="relative m-auto rounded-2 bg-white w-full  background-modal p-4 z-[120]" style="
            ...
            <div class=" overflow-hidden w-full h-full ">
                ...
                <div class=" w-full h-full mt-2 topping-row" style="text-align:start;overflow-y:auto;height:90%;padding-bottom:100px">
                    <div>
                        <div class="  flex items-center" style="justify-content: space-between;border: 1px solid;padding: 4px;">
                            <h2 class="form-title text-lg font-semibold border-l-4 border-purple-500 pl-2" style="font-size:14px">Topping dịch vụ</h2>
                                    ...
                                    <?php foreach ($desireTopping as $desire_topping) : ?>
                                        ...
                                        <label class="flex items-center justify-between py-2 border-b-1 border-gray-200 cursor-pointer">
                                            <div class="flex items-center space-x-2 gap-2">
                                                <input type="radio" name="desire-options" 
                                                    data-price="<?= $desire_topping["origin"] ?>"  
                                                    data-name="<?= $term->name ?>" 
                                                    value="<?= $desire_topping["origin"] ?>"   
                            ...
                            <div class="mt-4">
                                ...
                                <div>
                                    ...
                                    <?php foreach ($materialTopping as $material_topping) : ?>
                                        ...
                                        <label class="flex items-center justify-between py-2 border-b-1 border-gray-200 cursor-pointer">
                                            <div class="flex items-center space-x-2 gap-2">
                                                <input type="radio" name="material-options" 
                                                    data-price="<?= $material_topping["origin"] ?>"  
                                                    data-name="<?= $term->name ?>" 
                                                    value="<?= $material_topping["origin"] ?>"   
                            ...
                            <div class="mt-4">
                                ...
                                <div>
                                    ...
                                    <?php foreach ($bhTopping as $bh_topping) : ?>
                                        ...
                                        <label class="flex items-center justify-between py-2 border-b-1 border-gray-200 cursor-pointer">
                                            <div class="flex items-center space-x-2 gap-2">
                                                <input type="radio" name="bh-options" 
                                                    data-price="<?= $bh_topping["origin"] ?>"  
                                                    data-name="<?= $term->name ?>" 
                                                    value="<?= $bh_topping["origin"] ?>"   
