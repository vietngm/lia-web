...
<head>
	<style>
		...
		.bottom-action {
			...
			transition: transform 0.4s ease-in-out; /* Hiệu ứng mượt */
		}
		.items-introduce{
			justify-content: center;
		}
...
<div class="history-back cursor-pointer flex items-center gap-1" data-fallback="<?= get_permalink(get_field("page_doctor", "option")) ?>" style="padding:16px">
	<img class="w-4 h-4" src="<?= get_theme_file_uri("assets/images/icons/chevron-left-gray.svg") ?>" alt="" />
...
<main class="container">
	...
	<div class="row-rating">
		<h2 class="form-title text-lg font-semibold border-l-4 border-purple-500 pl-2" style="font-size:16px;color:#1A5477">Vị trí</h2>
		<div class="location">
            <iframe
	...
	<div class="row-service">
		...
		<div class="content-service mt-4">
			<?php if (!empty($fields["practitioners"]) && is_array($fields["practitioners"])) : ?>
				<?php foreach ($fields["practitioners"] as $practitionerId) : ?>
	...
	<div class="row-service">
		<h2 class="form-title text-lg font-semibold border-l-4 border-purple-500 pl-2" style="font-size:16px;color:#1A5477">Dịch vụ</h2>
		<div class="content-service mt-4">
