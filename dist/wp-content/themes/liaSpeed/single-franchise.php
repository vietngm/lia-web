...
.line {
    ...
    position: absolute;
    right: 0;
    background: linear-gradient(to right, #e8f5e917, #9CCF79); /* Hiệu ứng fade */
}
.grid-container {
    display: grid;
...
/* Màu nền cho từng ô */
.green { background-color: #ECFDF5; }   /* Xanh nhạt */
.yellow { background-color: #FFFBEB; } /* Vàng nhạt */
.blue { background-color: #EFF6FF; }   /* Xanh dương nhạt */
.red { background-color: #FEF2F2; }    /* Đỏ nhạt */
                ...
                <div class="support-section">
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Sau khi ký hợp đồng, bạn sẽ thanh toán theo phương thức đã chọn. Đối với thanh toán một lần, bạn cần thanh toán toàn bộ số tiền trong vòng 7 ngày. Đối với trả góp, bạn sẽ thanh toán theo lịch đã thỏa thuận trong hợp đồng.</p>
                        </div>
                    </div>
                    <div class="faq-item">
                        <div class="faq-question">
                        ...
                        <div class="faq-answer">
                            <p>Thời gian hoàn vốn được tính dựa trên tổng số tiền đầu tư và lợi nhuận dự kiến hàng tháng, không bao gồm các chi phí vận hành và thuế.</p>
                        </div>
                    </div>
                    <div class="faq-item">
                        <div class="faq-question">
                        ...
                        <div class="faq-answer">
                            <p>Có, LIA sẽ hỗ trợ đào tạo và vận hành trong suốt 6 tháng đầu tiên sau khi khai trương, bao gồm đào tạo nhân viên, quản lý và hỗ trợ kỹ thuật.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-body">
            <div class="policy-details">
                ...
                <div class="policy-note">
                    <p><strong>Lưu ý:</strong> Chính sách bảo hành không áp dụng cho các trường hợp hư hỏng do sử dụng sai mục đích, tác động của thiên nhiên, hoặc các yếu tố bên ngoài khác không thuộc về lỗi kỹ thuật.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="policy-details">
                ...
                <div class="policy-note">
                    <p><strong>Lưu ý:</strong> Phí chuyển khoản và các chi phí liên quan đến việc hoàn tiền (nếu có) sẽ do khách hàng chi trả. LIA cam kết minh bạch và công bằng trong việc xử lý các yêu cầu hoàn tiền.</p>
                </div>
            </div>
        </div>
    </div>
