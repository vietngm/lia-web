<div class="gap-2 flex flex-col">
  ...
  <?php
    ...
    $doctor_avatar = bfi_thumb(get_the_post_thumbnail_url($doctor_id), array("width" => 400, 'crop' => false));
      ...
      <div class="practitioner-summary">
        ...
        <div class=" w-full flex flex-col">
          ...
          <div class="gap-1 items-center">
            <div class="experience"><?= $doctor_experience ? esc_html($doctor_experience):2; ?> năm kinh nghiệm
            </div>
